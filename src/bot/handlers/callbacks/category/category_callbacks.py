...
from src.bot.filters.callbacks import AddCategory, SelectCategory, CategoryMenu, Menu, RemoveCategory, ModifyCategory, CategoryAction, ChangeTorrentCategory
from src.bot.handlers.common import list_categories, send_menu
from src.content_categories import build_content_category_keyboard
...
def get_router():
    ...
    async def category(callback_query: CallbackQuery, callback_data: CategoryAction, bot: Bot, settings: Settings) -> None:
        ...
        if callback_data.action.startswith("add_"):
            prompt = _("What are you adding?")
